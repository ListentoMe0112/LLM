...
from cs336_alignment.utils import tokenize_prompt_and_output, compute_entropy, get_response_log_probs, masked_normalize, sft_microbatch_train_step, compute_group_normalized_rewards, compute_naive_policy_gradient_loss
...
def run_compute_grpo_clip_loss(
    ...
    """
    return utils.compute_grpo_clip_loss(advantages, policy_log_probs, old_log_probs, cliprange)
...
def run_compute_policy_gradient_loss(
    ...
    """
    return utils.compute_policy_gradient_loss(policy_log_probs, loss_type, raw_rewards, advantages, old_log_probs, cliprange)
...
def run_masked_mean(tensor: torch.Tensor, mask: torch.Tensor, dim: int | None = None) -> torch.Tensor:
    ...
    """
    return utils.masked_mean(tensor, mask, dim)
...
def run_grpo_microbatch_train_step(
    ...
    """
    return utils.grpo_microbatch_train_step(policy_log_probs, response_mask, gradient_accumulation_steps, loss_type, raw_rewards, advantages, old_log_probs, cliprange)
