...
python benchmark.py --d_model=768 --d_ff=3072 --num_layers=12 --num_heads=12  --warm_up=3 --iteration=5 --no-compile
python benchmark.py --d_model=768 --d_ff=3072 --num_layers=12 --num_heads=12  --warm_up=3 --iteration=5 --compile
